...
$(document).ready(function(){
	...
	$('button:enabled,input[type="button"]:enabled').click(function(){
		$(this).attr('disabled',true);alert('k')
		setTimeout("$('button,input[type=\"button\"]').attr('disabled',false);",5000);
		return true;
	});
	*/
});
...
function showMsg(msg,isSuccess,callback){
	if ($('#_msgModal').length == 0) {
		var html = '<div class="modal fade" id="_msgModal" tabindex="-1" role="dialog" aria-labelledby="_msgModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">'
...
function confirmMsg(msg,callback){
	if ($('#_confirmModal').length == 0) {
		var html = '<div class="modal fade" id="_confirmModal" tabindex="-1" role="dialog" aria-labelledby="_confirmModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">'
			+'<div class="modal-dialog modal-sm">'
			+	'<div class="modal-content">'
			+		'<div class="modal-header">'
			+			'<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>'
...
function getLoadingHTML(){
	var html = '<div id="loading-mask"></div>'
				+'<div id="loading">'
				+'  <div class="popup">'
				+'    <div class="zzsc6">'
