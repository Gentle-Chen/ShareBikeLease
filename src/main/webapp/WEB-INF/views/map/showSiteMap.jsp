...
<body>
  ...
  <input id="s_name" type="hidden" value="" />
  <input id="s_longitude" type="hidden" value="" />
  <input id="s_latitude" type="hidden" value="" />
</body>
<script type="text/javascript">
    ...
    //标注点数组
    var markerArr = [{title:"${name}",content:"详细信息",point:"${longitude}|${latitude}",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
		 ];
    //创建marker
    function addMarker(){
